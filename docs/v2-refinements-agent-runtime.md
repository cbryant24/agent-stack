...
- Should not be built until the structured-references-and-research feature in docs/v2-refinements-music-curation.md is either landed or explicitly deferred, since they likely share retrieval and confirmation infrastructure.
