...
- Shared read-only "collection/artifact contracts" module in `agent-runtime`
  (already on `docs/v2-refinements/edit-brief-v2-refinements.md`) — F&I's brief parser adds a
...
adjacent ideas go to a `docs/v2-refinements/feedback-iteration-v2-refinements.md` deferred
