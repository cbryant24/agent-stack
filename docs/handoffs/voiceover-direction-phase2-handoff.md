...
- `docs/v2-refinements/music-curation-v2-refinements.md` — the Suno-docs-ingestion spec, applied analogously to `knowledge ingest-docs`.
- `docs/v2-refinements/agent-runtime-v2-refinements.md` — conversational chat mode (deferred here).
