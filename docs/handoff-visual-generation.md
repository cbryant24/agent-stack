...
- `docs/v2-refinements-voiceover-direction.md` — the `ingest-docs` batch/URL refinements and the reference/persona/chat-mode patterns that may apply analogously
