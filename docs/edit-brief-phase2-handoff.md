...
design rationale lives in `docs/edit-brief-phase1-handoff.md`; the durable
deferred-item record is `docs/v2-refinements-edit-brief.md`.
...
## Deferred to Phase 3 / V2 (full list in `docs/v2-refinements-edit-brief.md`)
...
the docs; anything not done moves to `docs/v2-refinements-edit-brief.md` with
